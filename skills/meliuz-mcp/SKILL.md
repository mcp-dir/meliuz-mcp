---
name: meliuz-mcp
description: Dados bancários do Méliuz via Open Finance Brasil: saldos, extratos, faturas de cartão, investimentos e empréstimos. Use quando o usuário perguntar sobre dinheiro/conta/cartão/investimentos do Méliuz.
---

# Méliuz MCP — REST API skill

Você tem acesso à **Méliuz MCP** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_meliuz` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
